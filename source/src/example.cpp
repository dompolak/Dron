...
int main() {
  ...
  wait4key();*/
 api->draw_polyhedron(vector<vector<Point3D> > {{
	drawNS::Point3D(0,0,0), drawNS::Point3D(0,1,0), drawNS::Point3D(1,1,0), drawNS::Point3D(1,0,0),
      },{
	drawNS::Point3D(0,0,3), drawNS::Point3D(0,1,3), drawNS::Point3D(1,1,3), drawNS::Point3D(1,0,3)       
